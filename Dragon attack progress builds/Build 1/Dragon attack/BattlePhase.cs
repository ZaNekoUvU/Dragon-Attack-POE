...
namespace Dragon_attack
{
    public partial class BattlePhase : Form
    {
        ...
        private void attackBtn_Click(object sender, EventArgs e)
        {
            ...
            else if (turn >= 2)// turn is set to >= 2 because the turn variable can be set to 3 which gives player two a second turn
            {
        ...
        private void specialAttackBtn_Click(object sender, EventArgs e)
        {
            ...
            if (turn <= 1) // turn is set to <= 1 because the turn variable can be set to 0 which gives player one a second turn
            {
                ...
                turn = turn + 2; //turn is incremented by 2 so that player two can have 2 turns
                count++;
            }
            ...
            else if (turn >= 2)// turn is set to >= 2 because the turn variable can be set to 3 which gives player two a second turn
            {
                ...
                turn = turn - 2; //turn is decremented by 2 so that player one can have 2 turns
                count++;
            }
        ...
        public void initiative()
        {
            ...
            if (rollCount == 0)
            {
                ...
                initiativeRollOne = rollOne.Next(1, 6);
                rollCount++;
            ...
            if (rollCount == 1)
            {
                ...
                initiativeRollTwo = rollTwo.Next(1, 6);
                rollCount--;
